...
protocol ReportingViewDelegate: AnyObject {
    func menuItemAction(_ index: Int)
    func backViewAction()
}

class ReportingView: GpBaseView {
    ...
    public weak var delegate: ReportingViewDelegate?
    ...
    override init() {
        super.init()
        title = "home.reporting.title".localized()
...
extension ReportingView: UITableViewDelegate, UITableViewDataSource {
