            ...
            if let builder = builder as? TransactionReportBuilder<T> {
                ...
                if builder.reportType == .transactionDetail,
                   let transactionId = builder.transactionId {
                    ...
                    addQueryStringParam(params: &queryStringParams, key: "from_time_created", value: builder.startDate?.format("yyyy-MM-dd"))
                    ...
                    addQueryStringParam(params: &queryStringParams, key: "from_stage_time_created", value: builder.searchCriteriaBuilder.startStageDate?.format("yyyy-MM-dd"))
