...
final class DepositByIDFormViewController: BaseViewController<DepositByIdFormViewModel> {
    
    private lazy var customView = {
        let view = DepositByIdFormView()
        view.delegate = self
        return view
    }()
...
extension DepositByIDFormViewController: DepositByIdFormViewDelegate {
