...
class GpApiApacHKCreditTests: XCTestCase {
    ...
    override func setUp() {
        ...
        visaCard.cvn = "852"
        visaCard.cardHolderName = "APAC HK Visa Test"
        ...
        mastercardCard.cardHolderName = "APAC HK Mastercard Test"
    }
    ...
    func test_hk_sale_visa() {
        // GIVEN
        let saleExpectation = expectation(description: "HK Sale Visa Expectation")
    ...
    func test_hk_sale_mastercard() {
        // GIVEN
        let saleExpectation = expectation(description: "HK Sale Mastercard Expectation")
        var saleResult: Transaction?
        var saleError: Error?
    ...
    func test_hk_auth_visa() {
        // GIVEN
        let authExpectation = expectation(description: "HK Auth Visa Expectation")
    ...
    func test_hk_auth_mastercard() {
        // GIVEN
        let authExpectation = expectation(description: "HK Auth Mastercard Expectation")
        var authResult: Transaction?
        var authError: Error?
    ...
    func test_hk_preauth_visa() {
        // GIVEN
        let preAuthExpectation = expectation(description: "HK Pre-Auth Visa Expectation")
    ...
    func test_hk_preauth_mastercard() {
        // GIVEN
        let preAuthExpectation = expectation(description: "HK Pre-Auth Mastercard Expectation")
        var preAuthResult: Transaction?
        var preAuthError: Error?
    ...
    func test_hk_auth_then_capture_visa() {
        // GIVEN
        let authExpectation = expectation(description: "HK Auth Expectation")
        var authResult: Transaction?
        var authError: Error?
        ...
        // GIVEN
        let captureExpectation = expectation(description: "HK Capture Expectation")
    ...
    func test_hk_auth_then_capture_mastercard() {
        // GIVEN
        let authExpectation = expectation(description: "HK Auth Mastercard Expectation")
        var authResult: Transaction?
        var authError: Error?
        ...
        // GIVEN
        let captureExpectation = expectation(description: "HK Capture Mastercard Expectation")
        var captureResult: Transaction?
        var captureError: Error?
    ...
    func test_hk_void_visa() {
        // GIVEN
        let saleExpectation = expectation(description: "HK Sale Expectation")
        var saleResult: Transaction?
        var saleError: Error?
        ...
        // GIVEN
        let voidExpectation = expectation(description: "HK Void Expectation")
    ...
    func test_hk_void_mastercard() {
        ...
        // GIVEN
        let voidExpectation = expectation(description: "HK Void Mastercard Expectation")
        var voidResult: Transaction?
        var voidError: Error?
    ...
    func test_hk_auth_reversal_visa() {
        // GIVEN
        let authExpectation = expectation(description: "HK Auth Expectation")
        var authResult: Transaction?
        var authError: Error?
        ...
        // GIVEN
        let reversalExpectation = expectation(description: "HK Auth Reversal Expectation")
    ...
    func test_hk_auth_reversal_mastercard() {
        // GIVEN
        let authExpectation = expectation(description: "HK Auth Mastercard Expectation")
        var authResult: Transaction?
        var authError: Error?
        ...
        // GIVEN
        let reversalExpectation = expectation(description: "HK Auth Reversal Mastercard Expectation")
        var reversalResult: Transaction?
        var reversalError: Error?
    ...
    func test_hk_refund_visa() {
        ...
        // GIVEN
        let refundExpectation = expectation(description: "HK Refund Visa Expectation")
    ...
    func test_hk_refund_mastercard() {
        // GIVEN
        let saleExpectation = expectation(description: "HK Sale Mastercard Expectation")
        var saleResult: Transaction?
        var saleError: Error?
        ...
        // GIVEN
        let refundExpectation = expectation(description: "HK Refund Mastercard Expectation")
        var refundResult: Transaction?
        var refundError: Error?
    ...
    func test_hk_partial_capture_visa() {
        ...
        // GIVEN
        let captureExpectation = expectation(description: "HK Partial Capture Expectation")
        var captureResult: Transaction?
        var captureError: Error?
    ...
    func test_hk_partial_capture_mastercard() {
        let partialAmount: NSDecimalNumber = 5.00
        ...
        // GIVEN
        let captureExpectation = expectation(description: "HK Partial Capture Mastercard Expectation")
        var captureResult: Transaction?
        var captureError: Error?
    ...
    func test_hk_moto_visa() {
        // GIVEN
        visaCard.entryMethod = .MOTO

        let motoExpectation = expectation(description: "HK MOTO Visa Expectation")
    ...
    func test_hk_moto_mastercard() {
        // GIVEN
        mastercardCard.entryMethod = .MOTO

        let motoExpectation = expectation(description: "HK MOTO Mastercard Expectation")
        var motoResult: Transaction?
        var motoError: Error?
