...
final class PaymentProcessViewController: BaseViewController<PaymentProcessViewModel> {
    
    private lazy var customView = {
        let view = PaymentProcessView()
        view.delegate = self
...
extension PaymentProcessViewController: GlobalPaymentProcessDelegate {
