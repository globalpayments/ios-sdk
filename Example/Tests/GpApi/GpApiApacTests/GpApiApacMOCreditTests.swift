...
class GpApiApacMOCreditTests: XCTestCase {
    ...
    override func setUp() {
        ...
        visaCard.cvn = "852"
        visaCard.cardHolderName = "APAC MO Visa Test"
        ...
        mastercardCard.cardHolderName = "APAC MO Mastercard Test"
    }
    ...
    func test_mo_sale_visa() {
        // GIVEN
        let saleExpectation = expectation(description: "MO Sale Visa Expectation")
    ...
    func test_mo_sale_mastercard() {
        // GIVEN
        let saleExpectation = expectation(description: "MO Sale Mastercard Expectation")
        var saleResult: Transaction?
        var saleError: Error?
    ...
    func test_mo_auth_visa() {
        // GIVEN
        let authExpectation = expectation(description: "MO Auth Visa Expectation")
    ...
    func test_mo_auth_mastercard() {
        // GIVEN
        let authExpectation = expectation(description: "MO Auth Mastercard Expectation")
        var authResult: Transaction?
        var authError: Error?
    ...
    func test_mo_preauth_visa() {
        // GIVEN
        let preAuthExpectation = expectation(description: "MO Pre-Auth Visa Expectation")
    ...
    func test_mo_preauth_mastercard() {
        // GIVEN
        let preAuthExpectation = expectation(description: "MO Pre-Auth Mastercard Expectation")
        var preAuthResult: Transaction?
        var preAuthError: Error?
    ...
    func test_mo_auth_then_capture_visa() {
        // GIVEN
        let authExpectation = expectation(description: "MO Auth Expectation")
        var authResult: Transaction?
        var authError: Error?
        ...
        // GIVEN
        let captureExpectation = expectation(description: "MO Capture Expectation")
    ...
    func test_mo_auth_then_capture_mastercard() {
        // GIVEN
        let authExpectation = expectation(description: "MO Auth Mastercard Expectation")
        var authResult: Transaction?
        var authError: Error?
        ...
        // GIVEN
        let captureExpectation = expectation(description: "MO Capture Mastercard Expectation")
        var captureResult: Transaction?
        var captureError: Error?
    ...
    func test_mo_void_visa() {
        // GIVEN
        let saleExpectation = expectation(description: "MO Sale Expectation")
        var saleResult: Transaction?
        var saleError: Error?
        ...
        // GIVEN
        let voidExpectation = expectation(description: "MO Void Expectation")
    ...
    func test_mo_void_mastercard() {
        ...
        // GIVEN
        let voidExpectation = expectation(description: "MO Void Mastercard Expectation")
        var voidResult: Transaction?
        var voidError: Error?
    ...
    func test_mo_auth_reversal_visa() {
        // GIVEN
        let authExpectation = expectation(description: "MO Auth Expectation")
        var authResult: Transaction?
        var authError: Error?
        ...
        // GIVEN
        let reversalExpectation = expectation(description: "MO Auth Reversal Expectation")
    ...
    func test_mo_auth_reversal_mastercard() {
        // GIVEN
        let authExpectation = expectation(description: "MO Auth Mastercard Expectation")
        var authResult: Transaction?
        var authError: Error?
        ...
        // GIVEN
        let reversalExpectation = expectation(description: "MO Auth Reversal Mastercard Expectation")
        var reversalResult: Transaction?
        var reversalError: Error?
    ...
    func test_mo_refund_visa() {
        ...
        // GIVEN
        let refundExpectation = expectation(description: "MO Refund Visa Expectation")
    ...
    func test_mo_refund_mastercard() {
        // GIVEN
        let saleExpectation = expectation(description: "MO Sale Mastercard Expectation")
        var saleResult: Transaction?
        var saleError: Error?
        ...
        // GIVEN
        let refundExpectation = expectation(description: "MO Refund Mastercard Expectation")
        var refundResult: Transaction?
        var refundError: Error?
    ...
    func test_mo_partial_capture_visa() {
        ...
        // GIVEN
        let captureExpectation = expectation(description: "MO Partial Capture Expectation")
        var captureResult: Transaction?
        var captureError: Error?
    ...
    func test_mo_partial_capture_mastercard() {
        let partialAmount: NSDecimalNumber = 5.00
        ...
        // GIVEN
        let captureExpectation = expectation(description: "MO Partial Capture Mastercard Expectation")
        var captureResult: Transaction?
        var captureError: Error?
    ...
    func test_mo_moto_visa() {
        // GIVEN
        visaCard.entryMethod = .MOTO

        let motoExpectation = expectation(description: "MO MOTO Visa Expectation")
    ...
    func test_mo_moto_mastercard() {
        // GIVEN
        mastercardCard.entryMethod = .MOTO

        let motoExpectation = expectation(description: "MO MOTO Mastercard Expectation")
        var motoResult: Transaction?
        var motoError: Error?
