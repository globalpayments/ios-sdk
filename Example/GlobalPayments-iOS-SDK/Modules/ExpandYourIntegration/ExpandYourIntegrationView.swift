...
protocol ExpandYourIntegrationViewDelegate: AnyObject {
    func menuItemAction(_ index: Int)
    func backViewAction()
}

class ExpandYourIntegrationView: GpBaseView {
    ...
    public weak var delegate: ExpandYourIntegrationViewDelegate?
    ...
    override init() {
        super.init()
        title = "home.expand.integration.title".localized()
...
extension ExpandYourIntegrationView: UITableViewDelegate, UITableViewDataSource {
