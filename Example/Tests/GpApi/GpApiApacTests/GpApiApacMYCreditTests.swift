...
class GpApiApacMYCreditTests: XCTestCase {
    ...
    override func setUp() {
        ...
        visaCard.cvn = "852"
        visaCard.cardHolderName = "APAC MY Visa Test"
        ...
        mastercardCard.cardHolderName = "APAC MY Mastercard Test"
    }
    ...
    func test_my_sale_visa() {
        // GIVEN
        let saleExpectation = expectation(description: "MY Sale Visa Expectation")
    ...
    func test_my_sale_mastercard() {
        // GIVEN
        let saleExpectation = expectation(description: "MY Sale Mastercard Expectation")
        var saleResult: Transaction?
        var saleError: Error?
    ...
    func test_my_auth_visa() {
        // GIVEN
        let authExpectation = expectation(description: "MY Auth Visa Expectation")
    ...
    func test_my_auth_mastercard() {
        // GIVEN
        let authExpectation = expectation(description: "MY Auth Mastercard Expectation")
        var authResult: Transaction?
        var authError: Error?
    ...
    func test_my_preauth_visa() {
        // GIVEN
        let preAuthExpectation = expectation(description: "MY Pre-Auth Visa Expectation")
    ...
    func test_my_preauth_mastercard() {
        // GIVEN
        let preAuthExpectation = expectation(description: "MY Pre-Auth Mastercard Expectation")
        var preAuthResult: Transaction?
        var preAuthError: Error?
    ...
    func test_my_auth_then_capture_visa() {
        // GIVEN
        let authExpectation = expectation(description: "MY Auth Expectation")
        var authResult: Transaction?
        var authError: Error?
        ...
        // GIVEN
        let captureExpectation = expectation(description: "MY Capture Expectation")
    ...
    func test_my_auth_then_capture_mastercard() {
        // GIVEN
        let authExpectation = expectation(description: "MY Auth Mastercard Expectation")
        var authResult: Transaction?
        var authError: Error?
        ...
        // GIVEN
        let captureExpectation = expectation(description: "MY Capture Mastercard Expectation")
        var captureResult: Transaction?
        var captureError: Error?
    ...
    func test_my_void_visa() {
        // GIVEN
        let saleExpectation = expectation(description: "MY Sale Expectation")
        var saleResult: Transaction?
        var saleError: Error?
        ...
        // GIVEN
        let voidExpectation = expectation(description: "MY Void Expectation")
    ...
    func test_my_void_mastercard() {
        ...
        // GIVEN
        let voidExpectation = expectation(description: "MY Void Mastercard Expectation")
        var voidResult: Transaction?
        var voidError: Error?
    ...
    func test_my_auth_reversal_visa() {
        // GIVEN
        let authExpectation = expectation(description: "MY Auth Expectation")
        var authResult: Transaction?
        var authError: Error?
        ...
        // GIVEN
        let reversalExpectation = expectation(description: "MY Auth Reversal Expectation")
    ...
    func test_my_auth_reversal_mastercard() {
        // GIVEN
        let authExpectation = expectation(description: "MY Auth Mastercard Expectation")
        var authResult: Transaction?
        var authError: Error?
        ...
        // GIVEN
        let reversalExpectation = expectation(description: "MY Auth Reversal Mastercard Expectation")
        var reversalResult: Transaction?
        var reversalError: Error?
    ...
    func test_my_refund_visa() {
        ...
        // GIVEN
        let refundExpectation = expectation(description: "MY Refund Visa Expectation")
    ...
    func test_my_refund_mastercard() {
        // GIVEN
        let saleExpectation = expectation(description: "MY Sale Mastercard Expectation")
        var saleResult: Transaction?
        var saleError: Error?
        ...
        // GIVEN
        let refundExpectation = expectation(description: "MY Refund Mastercard Expectation")
        var refundResult: Transaction?
        var refundError: Error?
    ...
    func test_my_partial_capture_visa() {
        ...
        // GIVEN
        let captureExpectation = expectation(description: "MY Partial Capture Expectation")
        var captureResult: Transaction?
        var captureError: Error?
    ...
    func test_my_partial_capture_mastercard() {
        let partialAmount: NSDecimalNumber = 5.00
        ...
        // GIVEN
        let captureExpectation = expectation(description: "MY Partial Capture Mastercard Expectation")
        var captureResult: Transaction?
        var captureError: Error?
    ...
    func test_my_moto_visa() {
        // GIVEN
        visaCard.entryMethod = .MOTO

        let motoExpectation = expectation(description: "MY MOTO Visa Expectation")
    ...
    func test_my_moto_mastercard() {
        // GIVEN
        mastercardCard.entryMethod = .MOTO

        let motoExpectation = expectation(description: "MY MOTO Mastercard Expectation")
        var motoResult: Transaction?
        var motoError: Error?
