...
class GpApiApacSGCreditTests: XCTestCase {
    ...
    override func setUp() {
        ...
        visaCard.cvn = "852"
        visaCard.cardHolderName = "APAC SG Visa Test"
        ...
        mastercardCard.cardHolderName = "APAC SG Mastercard Test"
    }
    ...
    func test_sg_sale_visa() {
        // GIVEN
        let saleExpectation = expectation(description: "SG Sale Visa Expectation")
    ...
    func test_sg_sale_mastercard() {
        // GIVEN
        let saleExpectation = expectation(description: "SG Sale Mastercard Expectation")
        var saleResult: Transaction?
        var saleError: Error?
    ...
    func test_sg_auth_visa() {
        // GIVEN
        let authExpectation = expectation(description: "SG Auth Visa Expectation")
    ...
    func test_sg_auth_mastercard() {
        // GIVEN
        let authExpectation = expectation(description: "SG Auth Mastercard Expectation")
        var authResult: Transaction?
        var authError: Error?
    ...
    // MARK: - 3. Pre-Auth (authorize with multi-capture flag)

    func test_sg_preauth_visa() {
        // GIVEN
        let preAuthExpectation = expectation(description: "SG Pre-Auth Visa Expectation")
    ...
    func test_sg_preauth_mastercard() {
        // GIVEN
        let preAuthExpectation = expectation(description: "SG Pre-Auth Mastercard Expectation")
        var preAuthResult: Transaction?
        var preAuthError: Error?
    ...
    func test_sg_auth_then_capture_visa() {
        // GIVEN
        let authExpectation = expectation(description: "SG Auth Expectation")
        var authResult: Transaction?
        var authError: Error?
        ...
        // GIVEN
        let captureExpectation = expectation(description: "SG Capture Expectation")
    ...
    func test_sg_auth_then_capture_mastercard() {
        // GIVEN
        let authExpectation = expectation(description: "SG Auth Mastercard Expectation")
        var authResult: Transaction?
        var authError: Error?
        ...
        // GIVEN
        let captureExpectation = expectation(description: "SG Capture Mastercard Expectation")
        var captureResult: Transaction?
        var captureError: Error?
    ...
    func test_sg_void_visa() {
        ...
        // GIVEN
        let voidExpectation = expectation(description: "SG Void Expectation")
    ...
    func test_sg_void_mastercard() {
        ...
        // GIVEN
        let voidExpectation = expectation(description: "SG Void Mastercard Expectation")
        var voidResult: Transaction?
        var voidError: Error?
    ...
    // MARK: - 6. Auth Reversal (reverse a preauthorized transaction)

    func test_sg_auth_reversal_visa() {
        // GIVEN
        let authExpectation = expectation(description: "SG Auth Expectation")
        var authResult: Transaction?
        var authError: Error?
        ...
        // GIVEN
        let reversalExpectation = expectation(description: "SG Auth Reversal Expectation")
    ...
    func test_sg_auth_reversal_mastercard() {
        // GIVEN
        let authExpectation = expectation(description: "SG Auth Mastercard Expectation")
        var authResult: Transaction?
        var authError: Error?
        ...
        // GIVEN
        let reversalExpectation = expectation(description: "SG Auth Reversal Mastercard Expectation")
        var reversalResult: Transaction?
        var reversalError: Error?
    ...
    // MARK: - 7. Refund (refund a captured Sale)

    func test_sg_refund_visa() {
        // GIVEN
        let saleExpectation = expectation(description: "SG Sale Visa Expectation")
        var saleResult: Transaction?
        var saleError: Error?
        ...
        // GIVEN
        let refundExpectation = expectation(description: "SG Refund Visa Expectation")
    ...
    func test_sg_refund_mastercard() {
        // GIVEN
        let saleExpectation = expectation(description: "SG Sale Mastercard Expectation")
        var saleResult: Transaction?
        var saleError: Error?
        ...
        // GIVEN
        let refundExpectation = expectation(description: "SG Refund Mastercard Expectation")
        var refundResult: Transaction?
        var refundError: Error?
    ...
    func test_sg_partial_capture_visa() {
        ...
        // GIVEN
        let captureExpectation = expectation(description: "SG Partial Capture Expectation")
        var captureResult: Transaction?
        var captureError: Error?

        // WHEN – capture only part of the authorised amount
    ...
    func test_sg_partial_capture_mastercard() {
        let partialAmount: NSDecimalNumber = 5.00
        ...
        // GIVEN
        let captureExpectation = expectation(description: "SG Partial Capture Mastercard Expectation")
        var captureResult: Transaction?
        var captureError: Error?
    ...
    func test_sg_moto_visa() {
        // GIVEN
        visaCard.entryMethod = .MOTO

        let motoExpectation = expectation(description: "SG MOTO Visa Expectation")
    ...
    func test_sg_moto_mastercard() {
        // GIVEN
        mastercardCard.entryMethod = .MOTO

        let motoExpectation = expectation(description: "SG MOTO Mastercard Expectation")
        var motoResult: Transaction?
        var motoError: Error?
