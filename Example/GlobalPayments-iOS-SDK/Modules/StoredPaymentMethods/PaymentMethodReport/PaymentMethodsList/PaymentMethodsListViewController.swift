...
final class PaymentMethodsListViewController: BaseViewController<PaymentMethodsListViewModel> {
    
    private lazy var customView = {
        let view = PaymentMethodsListView()
        view.delegate = self
        return view
    }()
...
extension PaymentMethodsListViewController: PaymentMethodsListViewDelegate {
