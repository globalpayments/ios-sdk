...
class AppChallengeStatusReceiver: ChallengeStatusReceiver {
    ...
    init(view: StatusView, dsTransId: String?, secureEcom: ThreeDSecure) {
    ...
    func completed(completionEvent: CompletionEvent) {
        if Transaction3dsStatus.AuthenticationSuccessful.rawValue == completionEvent.getTransactionStatus() {
