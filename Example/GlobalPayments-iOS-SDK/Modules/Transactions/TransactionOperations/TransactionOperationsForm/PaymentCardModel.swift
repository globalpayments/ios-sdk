...
extension PaymentCardModel {
    ...
    static var models: [PaymentCardModel] {
        [
            ...
            PaymentCardModel(name: "VISA_3DS1_NOT_ENROLLED", number: "4012001038443335", month: "5", year: "2025", cvv: "852"),
            PaymentCardModel(name: "VISA_3DS1_ENROLLED",     number: "4012001037141112", month: "5", year: "2025", cvv: "852")
        ]
    }
}
