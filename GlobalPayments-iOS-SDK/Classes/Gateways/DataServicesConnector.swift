...
class DataServicesConnector: RestGateway, ReportingService {
    ...
    private func hydrateTransactionSummary(_ root: JsonDoc) -> TransactionSummary {
        ...
        let amount: Decimal? = root.getValue(key: "transactionAmount")
        summary.amount = amount?.amount
        summary.currency = root.getValue(key: "transactionCurrency")
        let depositAmount: Decimal? = root.getValue(key: "transactionMerchantAmount")
        ...
        let adjustmentAmount: Decimal? = root.getValue(key: "transactionAdjustAmount")
    ...
    private func hydrateDepositSummary(_ root: JsonDoc) -> DepositSummary {
        ...
        let amount: Decimal? = root.getValue(key: "depositPaymentAmount")
        summary.amount = amount?.amount
        ...
        let salesTotalAmount: Decimal? = root.getValue(key: "salesTotalAmount")
        ...
        let refundsTotalAmount: Decimal? = root.getValue(key: "refundsTotalAmount")
        ...
        let chargebackTotalAmount: Decimal? = root.getValue(key: "disputeCbTotalAmount")
        ...
        let representmentTotalAmount: Decimal? = root.getValue(key: "disputeRepresentmentTotalAmount")
        ...
        let feesTotalAmount: Decimal? = root.getValue(key: "feesTotalAmount")
        ...
        let adjustmentTotalAmount: Decimal? = root.getValue(key: "adjustmentTotalAmount")
    ...
    private func hydrateDisputeSummary(_ root: JsonDoc) -> DisputeSummary {
        ...
        let caseAmount: Decimal? = root.getValue(key: "disputeCaseAmount")
        ...
        let transactionAmount: Decimal? = root.getValue(key: "disputeTransactionAmount")
        ...
        let disputeAmount: Decimal? = root.getValue(key: "disputeAmount")
        summary.disputeAmount = disputeAmount?.amount
        summary.disputeCurrency = root.getValue(key: "disputeCurrency")
        let disputeCustomerAmount: Decimal? = root.getValue(key: "disputeCustomerAmount")
